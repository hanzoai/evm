...
2. Add the metrics description in the crate's metrics describer module, e.g.: [network metrics describer](https://github.com/hanzoai/evm/blob/main/crates/net/network/src/metrics.rs).
