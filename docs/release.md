...
- [ ] Update [Homebrew Tap](https://github.com/hanzoai/homebrew-brew)
...
The release summary should include general notes on what the release contains that are important to operators. These changes can be found using the https://github.com/hanzoai/evm/labels/M-changelog label.
