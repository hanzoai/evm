...
use hanzo_evm_chainspec::{ChainSpecBuilder, EthereumHardfork, ForkCondition, MAINNET};
...
use hanzo_evm_testing_utils::generators::{self, sign_tx_with_key_pair};
use revm::{
...
fn block_gas_limit_error() {
    ...
    let mut executor = hanzo_evm_config.batch_executor(db);
