...
use hanzo_evm_node_core::exit::NodeExitFuture;

use crate::{node::FullNode, rpc::EvmRpcAddOns};

/// A Handle to the launched node.
#[must_use = "Needs to await the node exit future"]
pub struct NodeHandle<Node: FullNodeComponents, AddOns: EvmRpcAddOns<Node>> {
    /// All node components.
